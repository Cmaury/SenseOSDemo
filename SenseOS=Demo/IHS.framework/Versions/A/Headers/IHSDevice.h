...
/**
 @brief                 Deprecated! Name of the preferred physical IHS device.
 @deprecated            This property is no longer used. It returns nil and ignores writes.
 */
@property (copy, nonatomic) NSString* preferredDevice               /** @cond */ DEPRECATED_MSG_ATTRIBUTE("No longer used and any use will be ignored") /** @endcond */;
...
/**
 @brief                 Set to NO if no movement detected for at least 10s after startup,
                        ...
                        Otherwise YES.
 */
@property (nonatomic, readonly) BOOL gyroUncalibrated               /** @cond */ DEPRECATED_MSG_ATTRIBUTE("Deprecated. Please use gyroCalibrated property instead") /** @endcond */;

/**
 @brief                 Deprecated! Set the preferred device upon initializing the IHSDevice.
 ...
 @return                The successfully initialized instance or nil.
 @deprecated            This method is obsolete. We no longer use preferredDevice.@n
                        Please use IHSDevice#initWithDeviceDelegate: instead.
 */
- (IHSDevice*)initWithPreferredDevice:(NSString*)preferredDevice    /** @cond */ DEPRECATED_MSG_ATTRIBUTE("Please use initWithDeviceDelegate: instead") /** @endcond */;
