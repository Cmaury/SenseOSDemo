...
/**
 ...
 @note                  Changing this property while the instance is not assigned to a IHSAudio3DGridView will have no effect.
 */
...
/**
 ...
 @param audioSource     The audio source to initialize with.
