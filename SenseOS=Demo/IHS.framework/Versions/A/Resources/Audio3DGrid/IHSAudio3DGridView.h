...
/**
 @brief                 Message will be sent before the IHSAudio3DGridView will move an annotation
 @param audioGridView   The audio grid view that sent this message.
 @param annotation      The annotation to be moved.
 @return                If YES is returned the annotation will start to move. Return no to prohibit the moving of the annotation.
 */
- (BOOL)audioGridView:(IHSAudio3DGridView*)audioGridView shouldMoveAnnotation:(IHSAudio3DGridAnnotation*)annotation;
